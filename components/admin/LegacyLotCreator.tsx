...
// Pre-existing tool, moved here unchanged (just relocated out of the page
// file into its own component so /admin could grow tabs around it) — still
// targets a `coffee_lots` table that isn't part of the current schema
// (supabase/migrations/0001_init_schema.sql has `coffees` + `lots`
// instead), so saves here will error until that's reconciled. Left as-is
// since fixing/removing it wasn't part of this task.
export function LegacyLotCreator() {
