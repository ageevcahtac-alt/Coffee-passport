...
import { purgeNotificationPreferenceForUser } from '@/lib/data/notificationPreferencesStore';
import { purgeLotNotificationReadsForUser } from '@/lib/data/lotNotificationReadsStore';
...
export function reconcileUserScope(newUserId: string, isAuthenticated: boolean): void {
  ...
  if (previousUserId && previousUserId !== newUserId) {
    ...
    purgeNotificationPreferenceForUser(previousUserId);
    purgeLotNotificationReadsForUser(previousUserId);
  }
